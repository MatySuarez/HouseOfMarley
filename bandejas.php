...
$articulos=mysqli_query($conexion, "SELECT * FROM productos WHERE id_categoria = 12");
...
$productos = obtenerBandejas($desde,$registros_por_pagina);
...
<body>
    ...
    <main class="container">
        <div class="container mt-5 mb-5">
            <img src="bandejas/portada-tocadiscos.png" alt="portada" width="100%" height="100%">
        </div>
    </main>
    <section class="py-5">
                ...
                <div class="col mb-5 productos" category="<?php echo $data['categoria']; ?>">
                    <div class="card  h-100">
                        ...
                        <?php if (productoYaEstaEnCarrito($producto->id)) { ?>
                                    <form action="eliminarBandejas.php" method="post" class="text-center">
                                ...
                                <?php } else { ?>
                                    <form action="agregarBandejas.php" method="post" class="text-center">
                                        <input type="hidden" name="id_producto" value="<?php echo $producto->id ?>">
