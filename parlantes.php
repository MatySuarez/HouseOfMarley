...
$articulos=mysqli_query($conexion, "SELECT * FROM productos WHERE id_categoria = 11");
...
$productos = obtenerParlantes($desde,$registros_por_pagina);
...
<body>
    ...
    <main>
        <div class="container mt-5 mb-5 ">
            <img src="altavoces/portada-altavoces.png" alt="portada" width="100%" height="100%">
        </div>
    </main>
    <section class="py-5">
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 border-radius: 30px">
                <?php
                $query = mysqli_query($conexion, "SELECT * FROM productos WHERE id_categoria = 11");
                ...
                <div class="col mb-5 productos" category="<?php echo $data['categoria']; ?>">
                    <div class="card  h-100">
                        ...
                        <?php if (productoYaEstaEnCarrito($producto->id)) { ?>
                                    <form action="eliminarParlantes.php" method="post" class="text-center">
                                ...
                                <?php } else { ?>
                                    <form action="agregarParlantes.php" method="post" class="text-center">
                                        <input type="hidden" name="id_producto" value="<?php echo $producto->id ?>">
